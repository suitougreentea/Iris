(function() {
  var b2Body, b2BodyDef, b2FixtureDef, b2PolygonShape, b2Vec2;
  ...
  this.FieldNormal = (function() {
    function FieldNormal() {}

    FieldNormal.prototype.generate = function(world) {
      var b, ceilBody, ceilFixture, fixtureConfig, floorBody, floorFixture, floorSensorBody, floorSensorFixture, wallBody, wallFixture;
      ...
      return world.CreateBody(ceilBody).CreateFixture(ceilFixture);
    };
